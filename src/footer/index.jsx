...
<div className="container">
<div className="row pb-50 mb-pb-20 footer-top-content overflow-hidden">
...
<li><a href="#">Crypto Currenty</a></li>
...
<div className="d-flex flex-wrap justify-content-between footer-bottom-content">
<p className="order-2 order-lg-1">&copy; Copyright 2021 <a href="#"> CRYPTU </a> All Rights Reserved.</p>
...
<a className="backtop" href="#wrapper"><i className="far fa-long-arrow-up"></i></a>
        </>
    )
}
